...
try {
    ...
    for (const server of servers) {
        try {
            ...
            const output = execSync(`curl -m 25 -s -F "file=@./app/build/outputs/apk/release/app-release.apk" https://${server}.gofile.io/contents/uploadfile`);
    ...
    if (!uploaded) {
        ...
        try {
            const res = execSync('curl -m 180 --upload-file ./app/build/outputs/apk/release/app-release.apk https://transfer.sh/app-release.apk').toString();
            console.log(res);
        } catch(e) {
